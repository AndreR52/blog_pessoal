...
public class UsuarioControllerTest {
	...
	@Test
	@Order(5)
	@DisplayName("Localizar um usario pelo ID")
	public void deveMostrarUmUsuarioPeloId() {
		
		Optional<Usuario> buscarUsuario = usuarioService.cadastrarUsuario(new Usuario(0L,
				"Josenildo Almeida", "zenildo@email.com.br",
				"nildo123", "https://i.imgur.com/5M2p5Wb.jpg"));
	...
	public void deveLogarUmUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Samanta Albuquerque", "samanta@email.com.br", 
				"samanta123", "https://i.imgur.com/5M2p5Wb.jpg"));
		
		HttpEntity<UsuarioLogin> requisicao = new HttpEntity<UsuarioLogin>(new UsuarioLogin(0L, 
				"", "samanta@email.com.br", 
				"samanta123", "", ""));
